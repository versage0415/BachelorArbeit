...
public class TabCol5 implements Initializable {
    ...
    public void MyFunction5(String text , String i ){
    ...
    private void iniTable() {
        TabCol1.setCellValueFactory((new PropertyValueFactory<Tabelle5,String>("Header1")));
        TabCol2.setCellValueFactory((new PropertyValueFactory<Tabelle5,String>("Header2")));
        TabCol3.setCellValueFactory((new PropertyValueFactory<Tabelle5,String>("Header3")));
        TabCol4.setCellValueFactory((new PropertyValueFactory<Tabelle5,String>("Header4")));
        TabCol5.setCellValueFactory((new PropertyValueFactory<Tabelle5,String>("Header5")));
        EditTableCols();
    }
